...
export default function MovieCard3D({ movie, priority = false, onClick }: MovieCard3DProps) {
      ...
      <CardContainer className="inter-var w-full h-full" containerClassName="py-0 w-full h-full">
        ...
        >
          <motion.div 
            ...
            className="relative aspect-[2/3] w-full rounded-lg overflow-hidden bg-[#000000] shadow-lg shadow-[#343434]/20 group-hover/card:shadow-[#696969]/30 transition-shadow duration-300"
          >
